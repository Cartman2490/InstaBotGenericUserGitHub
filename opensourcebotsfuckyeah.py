...
### Extra error handling ###  
    ...
    if len(commandLineArguments) != 3:
        ...
        print()
        print("Enter your username below, without the '@' sign, then hit ENTER")
...
bot = InstaBot(
    ...
    like_per_day=785,
    comments_per_day=5,
    tag_list=['summer', 'love', 'cute', 'f4f', 'followforfollow', 'follow', 'fun', 'like', 'beach', 'photooftheday', 'beautiful', 'tbt', 'throwback', 'mcm', 'wcw'],
    tag_blacklist=['rain', 'thunderstorm', 'hashtag', 'tag', 'clothes', 'brand', 'shop', 'online', 'order', 'purchase', 'sale', 'subscribe', 'sex', 'porn'],
    user_blacklist={},
